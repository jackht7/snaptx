        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
            <div className='bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
              ...
              <h3 className='text-xl font-semibold text-gray-900 mb-2'>Fast Funding</h3>
              <p className='text-gray-600'>Get your invoices funded in as little as 24 hours with our streamlined process.</p>
            </div>
            ...
            <div className='bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
              ...
              <p className='text-gray-600'>Bank-level security and compliance ensure your data and transactions are protected.</p>
            </div>
            ...
            <div className='bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
              ...
              <p className='text-gray-600'>Our marketplace ensures competitive rates for both businesses and investors.</p>
            </div>
            ...
            <div className='bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
              ...
              <p className='text-gray-600'>Dedicated support team to help you navigate the financing process.</p>
            </div>
          </div>
        </div>
      </div>
